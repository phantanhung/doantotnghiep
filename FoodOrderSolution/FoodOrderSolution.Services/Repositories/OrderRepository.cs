...
namespace FoodOrderSolution.Services.Repositories
{
    ...
    {
        IEnumerable<OrderView> GetAll(long id);
    ...
    public class OrderRepository : RepositoryBase<Order>, IOrderRepository
    {
        ...
        public IEnumerable<OrderView> GetAll(long id)
        {
            try
            {
        ...
        public OrderView GetOrder(string code)
        {
            try
            {
                ...
                if(_item!=null && _item.ID != 0)
                {
                    ...
                    order.VendorID = _item.Vendor;
                    order.Vendor = DbContext.Vendors.FirstOrDefault(x => x.ID == _item.Vendor).Name ?? "";
                    return order;
                }
